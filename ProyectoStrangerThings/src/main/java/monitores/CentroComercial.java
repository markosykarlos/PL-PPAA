...
public class CentroComercial {
    ...
    public synchronized void acceder(Nino n) {
        ...
        System.out.println("El niño " + n.getIdNino() + " ha entrado al CENTRO COMERCIAL.");
    }

    public synchronized boolean salir(Nino n) {
        while (n.isSiendoAtacado()) {
            try {
                System.out.println("El niño " + n.getIdNino() + " intenta huir del CENTRO COMERCIAL pero está bajo ataque...");
                wait(); 
